...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildBalanceCard(double balance, bool loading) {
    final actions = [
      {'icon': Icons.north_rounded, 'label': 'Daftar', 'tone': 'blue', 'route': '/topup'},
      {'icon': Icons.send_rounded, 'label': 'Bagikan', 'tone': 'green', 'route': '/transfer'},
      {'icon': Icons.qr_code_rounded, 'label': 'Donasi', 'tone': 'violet', 'route': '/payment'},
