...
import '../../presentation/pages/payment/pay_page.dart';
...
class AppRouter {
  ...
  static final GoRouter router = GoRouter(
        ...
        routes: [
          ...
          GoRoute(
            path: '/pay',
            builder: (_, state) => _withPayment(PayPage(payload: state.extra)),
          ),
          GoRoute(
            path: '/pin',
            builder: (_, state) {
  ...
  static Widget _withOtp(Widget child) {
    return BlocProvider(create: (_) => sl<OtpBloc>(), child: child);
  }
  ...
  static Widget _withPayment(Widget child) {
    return BlocProvider(create: (_) => sl<PaymentBloc>(), child: child);
  }
}
